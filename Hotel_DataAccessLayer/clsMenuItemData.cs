...
namespace Hotel_DataAccessLayer
{
    public class clsMenuItemData
    {
        ...
        public static async Task<bool> IsMenuItemExistAsync(int ItemID)
        {
            bool IsFound = false;
        ...
        public static async Task<bool> IsMenuItemExistAsync(string ItemName)
        {
            bool IsFound = false;
        ...
        public static int AddNewMenuItem(string ItemName, byte ItemType, float Price, string Description, string ImagePath)
        {
            ...
            try
            {
                ...
                if (InsertedRowID != null)
                {
                    try
                    {
                        ItemID = Convert.ToInt32(InsertedRowID);
                    }
                    catch
                    {
                        ItemID = -1;
